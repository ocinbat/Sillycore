...
using RestSharp;
using Sillycore.RestClient.Decorators;
using Sillycore.RestClient.Serialization;
...
{
    public class SillycoreRestClient : RestSharp.RestClient
    {
        protected RestSharp.RestClient DecoratedClient;

        public SillycoreRestClient(string baseUrl)
        {
